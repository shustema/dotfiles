...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'https://canopy.uc.edu/webapps/login/?action=relogin'
...
config.bind('wq', ':wq')
config.bind('t', 'config-cycle input.spatial_navigation')
...
config.bind('wf', 'hint all')
config.bind('wt', 'hint all tab') 
config.bind('wb', 'hint all tab-bg')
config.bind('ww', 'hint all window')
...
config.bind('cc', 'spawn --userscript cast')
